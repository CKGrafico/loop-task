...
import * as __fd_glob_9 from "../content/docs/task-chaining.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/index.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/http-api.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.yaml": __fd_glob_0, }, {"agent-workflows.mdx": __fd_glob_1, "architecture.mdx": __fd_glob_2, "cli-reference.mdx": __fd_glob_3, "configuration.mdx": __fd_glob_4, "docker.mdx": __fd_glob_5, "getting-started.mdx": __fd_glob_6, "http-api.mdx": __fd_glob_7, "index.mdx": __fd_glob_8, "task-chaining.mdx": __fd_glob_9, "troubleshooting.mdx": __fd_glob_10, });